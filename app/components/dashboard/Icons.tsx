...
export function AppIcon({ name, className = "w-5 h-5", size = 20 }: IconProps) {
  switch (name?.toLowerCase()) {
    ...
    // ─── Social, Sustainability & Gamification ───
    case "leaf":
    case "eco":
    case "impact":
      return (
    ...
    case "hand":
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
          ...
          <path d="m3 11 6.6-6.6a2 2 0 0 1 2.8 0l1.4 1.4a2 2 0 0 1 0 2.8L7 15" />
          <path d="m2 14 2 2a2 2 0 0 0 2.8 0L9 14" />
          <path d="m14 17 2 2a2 2 0 0 0 2.8 0l2-2" />
        </svg>
      );
